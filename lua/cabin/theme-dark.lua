...
function M.get_theme(config)
	...
	cs.syntax_dimmed = palette.shade_dark8 -- Dimmed: Comments, LSP normal text, etc.
	...
	if config.fear_of_the_dark then
		...
		cs.elevation = {
			down2 = palette.black,
			down1 = palette.black,
			up1 = palette.shade_dark3,
			up2 = palette.shade_dark4,
			up3 = palette.shade_dark5,
		}
	else
		cs.elevation = {
			down2 = palette.black,
			down1 = palette.shade_dark1,
			up1 = palette.shade_dark4,
			up2 = palette.shade_dark5,
			up3 = palette.shade_dark6,
		}
	end
